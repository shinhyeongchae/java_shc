...
public class Ex12_Exception_Throw_Calculator {
 ...
 /*기능 : 두정수와 산술 연산자가 주어지면 산술연산 결과를 알려주는 메소드
  *  단 ; 연산자가 산술 연산자가 아니면 예외 발생
  *  매개변수 : 두정수와 산술 연산자
  *  리턴타입 : 산술연산 결과 = > 실수 = > double
  *  메소드명 : calculator*/

	public static double calulator(int num1, char op, int num2) throws Exception{
		double res = 0.0;
