...
public class AccountBookManager implements ConsoleProgram{
	...
	public AccountBookManager(Scanner scan) {
		...
		//샘플 데이터(테스트용)
		Item item = new Item("ex) 2022-05-13", false, "신용카드", "점심", 7000);
	...
	public boolean modifyAccountBook() {
		...
		if(tmp != null) {
			...
			System.out.println("잘못된 내역입니다.");
			return false;
		}
		System.out.println("");
		System.out.println("=====================");
		System.out.println("선택한사항은 위 내용입니다. 수정 하시겠습니까?[예 :true |아니요 :false");
	...
	public Item deleteAccountBook() {
		...
		System.out.println("");
		System.out.println("=====================");
		System.out.println("선택한사항은 위 내용입니다. 삭제1 하시겠습니까?[예 :true |아니요 :false");
		boolean ok = scan.nextBoolean();
		if(!ok) {
			return null;
		}
