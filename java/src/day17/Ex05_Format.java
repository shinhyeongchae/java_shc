...
public class Ex05_Format {
	...
	public static void main(String[] args) {
		...
		String id = "abc";
		String name = "홍길동";
		String number = "010-7878-7894";
		String user1 = "아이디 : " + id + ",이름 : " + name + ",번호 : " + number;
		System.out.println(user1);
		
		
		//문자열 포맷을 생성. 원하는 변수값이 들어가야할 위치를{숫자}로 표시해야함.
		String msFormat = "아이디 : {0}, 이름 : {1}, 번호 : {2}";
		//MessagerFormat.format(문자열포맷, 객체들)을 이용하여 문자열 포맷에 값들을 대입한 후 문자열 생성.
		String user2 = MessageFormat.format(msFormat, id , name, number);
		System.out.println(user2);
		
		
		Object objs[]= {"abc","홍길동", "010-1234-4567"};
