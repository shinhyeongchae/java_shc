drop database if exists 대학생;
create database if not exists 대학생;
...
-- 학번 2022135002 유관순 학생 추가
-- 학번 2022135001 이순신 학생 추가
...
insert into 수강(학번, 강좌코드) select '2022135002', 강좌코드 from 강좌 where 강좌명 = '기초전기';
-- 이순신 학생
insert into 수강(학번, 강좌코드) select '2022135001', 강좌코드 from 강좌 where 강좌명 = '대학수학기초';
...
-- 나영석 교수가 강의하는 강좌 목록조회 쿼리
select * from 강좌 where 교번 = (select 교번 from 교수 where 이름 = '나영석');
