...
insert into seat(se_ci_num,se_name,se_type,se_use) 
	values ('2','A1','일반','Y'),('2','A2','일반','Y'),('2','B1','일반','Y'),('2','B2','일반','Y'),('2','C1','일반','Y'),
		   ('2','C2','일반','Y'),('2','D1','일반','Y'),('2','D2','일반','Y'),('2','E1','일반','Y'),('2','E2','일반','Y');
insert into seat(se_ci_num,se_name,se_type,se_use) 
	values ('3','A1','일반','Y'),('3','A2','일반','Y'),('3','B1','일반','Y'),('3','B2','일반','Y'),('3','C1','일반','Y'),
		   ('3','C2','일반','Y'),('3','D1','일반','Y'),('3','D2','일반','Y'),('3','E1','일반','Y'),('3','E2','일반','Y');
insert into seat(se_ci_num,se_name,se_type,se_use) 
	values ('4','A1','일반','Y'),('4','A2','일반','Y'),('4','B1','일반','Y'),('4','B2','일반','Y'),('4','C1','일반','Y'),
		   ('4','C2','일반','Y'),('4','D1','일반','Y'),('4','D2','일반','Y'),('4','E1','일반','Y'),('4','E2','일반','Y');
insert into seat(se_ci_num,se_name,se_type,se_use) 
	values ('5','A1','일반','Y'),('5','A2','일반','Y'),('5','B1','일반','Y'),('5','B2','일반','Y'),('5','C1','일반','Y'),
...
-- CGV제주 상영관 좌석정보추가	
insert into seat(se_ci_num,se_name,se_type,se_use) 
	values ('6','A1','일반','Y'),('6','A2','일반','Y'),('6','A3','일반','Y'),('6','B1','일반','Y'),('6','B2','일반','Y'),('6','B3','일반','Y'),
    ('6','C1','일반','Y'),('6','C2','일반','Y'),('6','C3','일반','Y');
insert into seat(se_ci_num,se_name,se_type,se_use) 
	values ('7','A1','일반','Y'),('7','A2','일반','Y'),('7','A3','일반','Y'),('7','B1','일반','Y'),('7','B2','일반','Y'),('7','B3','일반','Y'),
    ('7','C1','일반','Y'),('7','C2','일반','Y'),('7','C3','일반','Y');
insert into seat(se_ci_num,se_name,se_type,se_use) 
	values ('8','A1','일반','Y'),('8','A2','일반','Y'),('8','A3','일반','Y'),('8','B1','일반','Y'),('8','B2','일반','Y'),('8','B3','일반','Y'),
    ('8','C1','일반','Y'),('8','C2','일반','Y'),('8','C3','일반','Y');

-- 브로커 6/14 cgv성안길 일정을 추가
-- 1관
insert into screen(sc_mo_num,sc_ci_num,sc_start_time,sc_pos_seat,sc_end_time) 
	values  (1,1,'2022-06-14 11:30','10','2022-06-14 13:49'),
			...
			(1,1,'2022-06-14 16:30','102022-06-14 18:59');
-- 2관
 insert into screen(sc_mo_num,sc_ci_num,sc_start_time,sc_pos_seat,sc_end_time) 
	values  (1,2,'2022-06-14 10:25','10','2022-06-14 12:44'),
...
-- 3관   
insert into screen(sc_mo_num,sc_ci_num,sc_start_time,sc_pos_seat,sc_end_time) 
	values  (1,3,'2022-06-14 11:00','10','2022-06-14 13:19'),
...
insert into `user` values('abc123','abc123');
-- abc123회원이 6/14일 CGV청주성안길에서 11:30에 하는 여화 브로커 A1,A2좌석을 예매, 가격은 자리당 10000원.
...
truncate table book; -- 테이블을 초기화하지 못하는 이유는 외래키로 지정되어있기 때문이다.

-- 예매 내역을 추가 bookdetail 테이블 데이터 추가
-- insert into bookdetail(bd_bo_num,bd_price,bd_price) 
