-- 1번 게시글에 qwer1234회원이 만나서 반가워요라고 댓글달앗다
...
-- 1번 댓글의 댓글로 admin123 관리자가 잘부탁합니다 라고 댓글을 달았다
insert into comment(co_contents, co_us_id, co_bd_num, co_secret, co_ori_num , co_depth)
	select '잘부탁합니다', 'admin123',co_bd_num, 0,  1, co_depth + 1
...
-- 샘플 추천/비추천 추가
INSERT INTO `community`.`likes` (`li_num`, `li_us_id`, `li_state`, `li_target`, `li_target_num`) 
	VALUES ('2', 'admin123', '1', 'board', '1');
INSERT INTO `community`.`likes` (`li_num`, `li_us_id`, `li_state`, `li_target`, `li_target_num`)
	VALUES ('3', 'abcd1234', '-1', 'board', '1');
INSERT INTO `community`.`likes` (`li_num`, `li_us_id`, `li_state`, `li_target`, `li_target_num`)
	VALUES ('4', 'qwer1234', '-1', 'board', '4');
