...
public class MemberServiceImp implements MemberService {
  ...
  MemberDAO memberDao;
	...
	public boolean sendEmail(String to, String title, String content) {
      ...
      messageHelper.setFrom("hyungchae798@gmail.com");  // 보내는사람 생략하거나 하면 정상작동을 안함
	...
	@Override
	public void updateMemberSession(String me_id, String session_id, Date session_limi) {
		if(me_id == null)
			return;
		memberDao.updateMemberSession(me_id, session_id, session_limi);
	}
